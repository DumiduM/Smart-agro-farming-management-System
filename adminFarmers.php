...
<div class="col-lg-12">
                    <center><h2 class = "text-primary">Current Farmers Registered in E-Farmer</h2></center>
          <hr>
        <div>
...
<script type = "text/javascript">
  $(document).ready(function(){
    ...
    $(document).on('click', '.delete', function(){
      var result = confirm("Do you really want to delete this user from the System?");
      if(result)
      {
      $id=$(this).val();
        $.ajax({
