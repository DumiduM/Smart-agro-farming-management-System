...
$query = sprintf("SELECT crop.nameENG AS Crop, SUM(amount) AS Harvest from harvest,farmercrop,variety,crop WHERE harvest.scheduleID = farmercrop.scheduleID AND farmercrop.verityID = variety.varietyID AND variety.cropID = crop.cropID AND farmercrop.location = '$division' GROUP BY crop.nameENG ORDER BY SUM(amount) DESC
");
