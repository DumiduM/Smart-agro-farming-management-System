    ...
    <div class="content-wrapper" id="bodyhome">
        <div class="container-fluid">
            ...
            <form method="post" enctype="multipart/form-data" name="formUploadFile" id="uploadForm" action="uploadVariety.php">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" id="cropNameENG" name="cropNameENG" placeholder="English Name">
                        </div>
                        <div class="col-md-3">
            ...
            <div class="row">
               ...
               //save table
                  $(document).on('click', '#saveKanna', function(){
                  $id=$(this).val();
                  $cropName=$('#cropNameENG').val();
                  $yalaUp=$('#yalaUp'+$id).val();
                  $yalaDown=$('#yalaDown'+$id).val();
                  $mahaUp=$('#mahaUp'+$id).val();
                  $mahaDown=$('#mahaDown'+$id).val();
                  $.ajax({
                  type: "POST",
                  url: "saveKanna.php",
                  data: {
