            ...
            <div class="modal-content">
                ...
                <form class="form-inline">
                    <div class="modal-body">
                        Firstname:
                        <input type="text" value="<?php echo $nrow['amount']; ?>" id="uamount<?php echo $urow['harvestID']; ?>" class="form-control"> Lastname:
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="updateuser btn btn-success" value="<?php echo $urow['harvestID']; ?>"><span class="glyphicon glyphicon-floppy-disk"></span> Save</button>
                    </div>
                </form>
            </div>
        </div>
