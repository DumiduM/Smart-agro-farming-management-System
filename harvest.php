...
<head>
    ...
    <div class="container">
        ...
        <div id="awcc1528797381923" class="aw-widget-current" data-locationkey="307308" data-unit="c" data-language="en-us" data-useip="false" data-uid="awcc1528797381923"></div>
        <script type="text/javascript" src="https://oap.accuweather.com/launch.js"></script><br><br>
            ...
            <div class="row">
                ...
                <div class="col-md-6 well">
                    <div class="row">
                        <div class="col-lg-12">
                            <center>
                                <h2 class="text-primary">Did you Harvested your crop already?</h2>
                            </center>
                            <hr>
                            <div class="form-group">
                                ...
                                <?php
                                  ...
                                  if ($result->num_rows > 0)
                                  {
                                    ...
                                    {
                                      echo "<option value='".$row['scheduleID']."'>".$row['dateSc']." ".$row['varietyName']."</option>";
                                    }
                                  }                               
                                ?>
                                </select>
